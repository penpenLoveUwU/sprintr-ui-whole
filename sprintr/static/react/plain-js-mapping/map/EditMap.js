...
class EditMap extends Map {
  ...
  onTap(evt) {
    ...
    if (this.props.robotStatus.value === "docked") {
      ...
      if (this.props.mode === "segments" && this.state.cuttingLine === undefined) {
        const {
          x,
          y
        ...
        if (intersectingSegmentId) {
          ...
          if (this.state.selectedSegmentIds.length < 2 || this.state.selectedSegmentIds.includes(intersectingSegmentId)) {
  ...
  render() {
    ...
    }), /*#__PURE__*/React.createElement(ActionsContainer, null, (this.props.supportedCapabilities[Capability.MapSegmentEdit] || this.props.supportedCapabilities[Capability.MapSegmentRename]) && this.props.mode === "segments" && /*#__PURE__*/React.createElement(SegmentActions, {
    ...
    }), this.props.supportedCapabilities[Capability.CombinedVirtualRestrictions] && this.props.mode === "virtual_restrictions" && /*#__PURE__*/React.createElement(VirtualRestrictionActions, {
      robotStatus: this.props.robotStatus,
