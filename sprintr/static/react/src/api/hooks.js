...
export const useWifiConfigurationMutation = (options) => {
    const { refetch: refetchWifiStatus, } = useWifiStatusQuery();
...
export const useUpdaterCommandMutation = () => {
    const { refetch: refetchUpdaterState, } = useUpdaterStateQuery();
...
export const useSetQuirkValueMutation = () => {
    const { refetch: refetchQuirksState, } = useQuirksQuery();
