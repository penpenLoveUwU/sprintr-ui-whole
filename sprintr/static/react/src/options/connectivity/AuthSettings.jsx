...
const AuthSettings = () => {
    const { data: storedConfiguration, isLoading: configurationLoading, isError: configurationError, } = useHTTPBasicAuthConfigurationQuery();
    ...
    return (<PaperContainer>
            <Grid container direction="row">
                <Box style={{ width: "100%" }}>
                    <DetailPageHeaderRow title="HTTP Basic Auth" icon={<BasicAuthIcon />}/>
                ...
                setConfigurationModified(true);
                    ...
                    <Grid container spacing={1} sx={{ mb: 1 }} direction="row">
                        <Grid item xs="auto" style={{ flexGrow: 1 }}>
                            <TextField style={{ width: "100%" }} label="Username" value={username} variant="standard" disabled={!enabled} onChange={e => {
            ...
            setConfigurationModified(true);
                        ...
                        <Grid item xs="auto" style={{ flexGrow: 1 }}>
                            <FormControl style={{ width: "100%" }} variant="standard">
                                ...
                                <Input type={showPasswordAsPlain ? "text" : "password"} fullWidth value={password} disabled={!enabled} endAdornment={<InputAdornment position="end">
