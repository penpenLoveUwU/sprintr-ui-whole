...
const CurrentStatistics = () => {
    const { data: currentStatistics, isLoading: statisticsLoading, isError: statisticsLoadError, } = useCurrentStatisticsQuery();
    const body = React.useMemo(() => {
        ...
        return currentStatistics.map((stat, i) => {
            return (<Grid item xs container direction="column" key={i}>
                    <Grid item>
                ...
                <Grid container direction="column">
                    <Box px={2} pt={1}>
                        <Grid item container alignItems="center" spacing={1}>
                            ...
                            <Grid item>
                                <LoadingFade in={statisticsLoading} transitionDelay={statisticsLoading ? "500ms" : "0ms"} size={20}/>
                            </Grid>
                        </Grid>
