...
const LiveMapPage = (props) => {
    ...
    return <LiveMap rawMap={mapData} theme={theme} trackSegmentSelectionOrder={mapSegmentationProperties ? mapSegmentationProperties.customOrderSupport : false} supportedCapabilities={{
