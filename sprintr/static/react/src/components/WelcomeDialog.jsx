...
const FullCleanupButtonItem = () => {
    ...
    return (<ButtonListMenuItem primaryLabel="Full Cleanup" secondaryLabel="Create a new map" icon={<MappingPassIcon />} buttonLabel="Go" confirmationDialog={{
...
const WelcomeDialog = ({ open, hide }) => {
    ...
    const { mutate: dismissWelcomeDialog, } = useDismissWelcomeDialogMutation();
