...
const ValetudoAppBar = ({ paletteMode, setPaletteMode }) => {
    ...
    const drawerContent = React.useMemo(() => {
        return (<Box sx={{ width: 250 }} role="presentation" onClick={() => {
                setDrawerOpen(false);
            }} onKeyDown={() => {
                setDrawerOpen(false);
            }} style={{
                ...
                switch (value.kind) {
                    case "Subheader":
                        return (<ListSubheader key={`${idx}`} sx={{ background: "transparent" }}>
                                        {value.title}
                                    </ListSubheader>);
                    case "MenuEntry": {
                        ...
                        return (<ListItem key={value.routeMatch} button selected={value.routeMatch === currentTab} component={Link} to={value.routeMatch}>
                                        <ListItemIcon>
                                            <ItemIcon />
                                        </ListItemIcon>
                ...
                setPaletteMode(e.target.checked ? "dark" : "light");
                    ...
                    <ListItem button component="a" href="./swagger/" target="_blank" rel="noopener">
                        <ListItemIcon>
                            <SwaggerUIIcon />
                        </ListItemIcon>
                    ...
                    <Divider />
                    <ListItem button component="a" href="https://valetudo.cloud" target="_blank" rel="noopener">
                        <ListItemIcon>
                            <DocsIcon />
                        </ListItemIcon>
                        <ListItemText primary="Docs"/>
                    </ListItem>
                    <ListItem button component="a" href="https://github.com/Hypfer/Valetudo" target="_blank" rel="noopener">
                        <ListItemIcon>
                            <GithubIcon />
                        </ListItemIcon>
                        <ListItemText primary="Hypfer/Valetudo"/>
                    </ListItem>
                    <ListItem button component="a" href="https://github.com/sponsors/Hypfer" target="_blank" rel="noopener">
                        <ListItemIcon>
                            <DonateIcon />
                        </ListItemIcon>
    ...
    const toolbarContent = React.useMemo(() => {
        switch (currentMenuEntry.kind) {
            ...
            case "MenuSubEntry":
                return (<>
                        <IconButton size="large" edge="start" color="inherit" aria-label="back" sx={{ mr: 2 }} component={Link} to={currentMenuEntry.parentRoute}>
                            <BackIcon />
                        </IconButton>
                        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
                            {pageTitle}
